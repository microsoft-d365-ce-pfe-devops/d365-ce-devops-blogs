...
2. Navigate to the directory where you want the tools downloaded. The code below will create the folder structure tools\
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODQzMDQ3MDMsMTM2NDIyMTM2MCwxMD
